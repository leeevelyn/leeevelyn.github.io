...
btnNo.addEventListener('click', () => {
  ...
  regret.textContent = `Sorry you can't come ${getName()} :(`;
});
...
function updateConfirmation() {
  ...
  if (guests == 0) {
    ...
    line = "bringing 1 guest";
  } else {
    line = "bringing lots of guests";
  }
  // YOUR CODE HERE: build guestLine based on guests value
  let guestLine = guests;
  confirmation.textContent = (`${getName()} is coming! ${line}.`);
