...
document.addEventListener('DOMContentLoaded', function() {
    ...
    loadButton.addEventListener('click', async function() {
        ...
        updateStatus("loading", "Loading Up!");
        document.getElementById("load-data-button").disabled = true;   
        ...
        try {
            ...
            // YOUR CODE HERE:
            updateStatus("success", "Loading Complete!");
    ...
    displayButton.addEventListener('click', function() {
        ...
        restaurants.forEach(function(restaurant) { 
            return restaurantList.innerHTML += `<div>${restaurant.name}</div>`;
        })
    ...
    mapButton.addEventListener('click', function() {
        ...
        const names = restaurants.map(function(restaurant) { 
            return mappedList.innerHTML += `<div>${restaurant.name}</div>`;
        })
    ...
    errorButton.addEventListener('click', async function() {
        ...
        try {
            ...
            // YOUR CODE HERE:
            errorDisplay.innerHTML ='<div class="status-display loading"><p class="status-message"> So sorry! It looks like there is an issue right now. We are working on the issue now.</p></div>';
